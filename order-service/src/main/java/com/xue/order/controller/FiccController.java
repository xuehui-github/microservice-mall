...
public class FiccController {
    ...
    public Result<PageResult<OdsIasEvalOne>> queryOdsIasEvalList(
            @Parameter(description = "账户明细查询请求") @RequestBody OdsIasEvalRequest odsIasEvalRequest) {
        return Result.success(ficcService.queryOdsIasEvalList(odsIasEvalRequest));
    }
    ...
    public Result<PageResult<OdsAppGsmTgValuAssetLiabDQ>> queryOdsIasEvalOfInList(
            @Parameter(description = "账户明细查询请求") @RequestBody OdsAppGsmRequest request) {
        return Result.success(ficcService.queryOdsIasEvalOfInList(request));
    }
    ...
    public Result<PageResult<DwdEvalOne>> queryDwdEvalOneList(
            @Parameter(description = "账户明细查询请求") @RequestBody OdsIasEvalRequest request) {
        return Result.success(ficcService.queryDwdEvalOneList(request));
    }
}
